...
const ChapterListItem = () => {
    return (
        <div className='chapter-list-item'>
            ...
            <Link to='/title/1'><span className='chapter-list-item__date'>09.12.2020</span></Link>
            <Link to='/title/1'><span className='chapter-list-item__translate'>Google Translate</span></Link>
